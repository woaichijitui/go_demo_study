...
var file_proto_hello_proto_rawDesc = []byte{
	...
	,
...
var file_proto_hello_proto_goTypes = []interface{}{
	...
	(*HellResponse)(nil), // 1: hello_grpc.HellResponse
}
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: hello_grpc.Hello.Hello:input_type -> hello_grpc.HelloRequest
	1, // 1: hello_grpc.Hello.Hello:output_type -> hello_grpc.HellResponse
...
type HelloClient interface {
	Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HellResponse, error)
}
...
func (c *helloClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HellResponse, error) {
	out := new(HellResponse)
	err := c.cc.Invoke(ctx, "/hello_grpc.Hello/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloServer interface {
	Hello(context.Context, *HelloRequest) (*HellResponse, error)
}
...
func (*UnimplementedHelloServer) Hello(context.Context, *HelloRequest) (*HellResponse, error) {
...
func _Hello_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello_grpc.Hello/Hello",
	}
